...
public class Problem_56 {
    public static void main(String[] args) {
          ...
          int array[]={2,5,3,9,5,3};


          int left_sum=0,right_sum=0,min_num=Integer.MAX_VALUE,index=-1;;
          ...
          for(int i=0; i<array.length; i++){
              ...
              if(array.length-(i+1)==0){
                  ...
                  right_sum=right_sum/(array.length-(i+1));
              }
          ...
          System.out.println("MiniMum Avggg : "+min_num);
